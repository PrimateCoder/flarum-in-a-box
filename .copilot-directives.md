...
- **CHANGELOG entries**: extreme brevity. One short line per change is ideal. Don't list affected files, paths, byte counts, root causes, "previously X bytes / now Y bytes" comparisons, or implementation details. Users only need to know what changed at a high level.
